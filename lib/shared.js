...
// default: like ballast, this plugin has always answered `non_loopback_peer` for a
// peer it cannot identify as well as for one that is off-loopback, and `non_loopback`
