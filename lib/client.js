...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const I18N = {
      zh: { title: 'TreeKeeper', subtitle: '进程树对账', leaks: '泄漏告警', none: '没有发现异常', jobs: '未归属任务账本', host: 'DSH 宿主后代', unknown: '未归属进程', kill: '树杀', confirm: '确认杀整棵树？', confirmBody: '将对以下进程树执行 taskkill /T /F：', refresh: '刷新', refreshing: '采样中', close: '关闭', sampling: '正在读取当前宿主的进程快照…', degraded: '降级采样（无父进程链，已禁止树杀）', unattr: '未归属', closed: '连接失败', findings: '发现', descendants: '后代' },
      en: { title: 'TreeKeeper', subtitle: 'process reconciliation', leaks: 'Leak findings', none: 'Nothing unusual', jobs: 'Unowned-job ledger', host: 'DSH host descendants', unknown: 'Unattributed', kill: 'Kill tree', confirm: 'Kill the whole tree?', confirmBody: 'taskkill /T /F will run on this tree:', refresh: 'Refresh', refreshing: 'Sampling', close: 'Close', sampling: 'Reading the current host process snapshot…', degraded: 'Degraded sampling (tree kill disabled)', unattr: 'unattributed', closed: 'request failed', findings: 'Findings', descendants: 'Descendants' }
    }
